...
class TestDistribution(unittest.TestCase):
    ...
    def test_csf_length(self):
        ...
        p_1 = self.dist.csf(0, 0)
        p_2 = self.dist.csf(50, 100)
    ...
    def test_csf_start_and_end(self):
        ...
        p_start = ss.weibull_min.sf(
            50, self.beta, scale=self.alpha, loc=self.gamma)
        p_end = ss.weibull_min.sf(
            100, self.beta, scale=self.alpha, loc=self.gamma)
    ...
    def test_cff_length(self):
        ...
        p_1 = self.dist.cff(0, 0)
        p_2 = self.dist.cff(50, 100)
