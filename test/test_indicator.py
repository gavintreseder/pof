...
class TestConditionIndicator(unittest.TestCase):
    ...
    def test_sim_timeline_two_causes(self):
        ...
        ci.sim_timeline(t_stop=200, name="cause_1")
        ci.sim_timeline(t_stop=200, name="cause_2")

        timeline_1 = ci.get_timeline(name="cause_1")
        timeline_2 = ci.get_timeline(name="cause_2")
