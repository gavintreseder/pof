...
def update_insp_interval(
    ...
    *args,
    ...
    if active:
        ...
        insp_interval_fig = make_inspection_interval_fig(
            sens_sim, t_min=1, t_max=10, step=1, n_iterations=n_iterations
        )
...
app.run_server(debug=True, use_reloader=True, port=8600)
